...
export default function CompanyRow({ company }: CompanyRowProps) {
    return (
        <tr className='h4 text center text-gray-900 bg-white'>
            <td className='text-xs font-medium text-blue-700 rounded-l border-1-4 border-blue-700'>
